...
| Deep static-review findings beyond the 7 categories (security / ops / data-integrity, S1–S15) | [`docs/audit/SUPPLEMENTARY-FINDINGS.md`](docs/audit/SUPPLEMENTARY-FINDINGS.md) |
