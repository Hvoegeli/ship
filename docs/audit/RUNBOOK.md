...
<this>   #Q3 Path-1+3: extend cat7-sr-tree dismissal experiment; CORRECT H4/H9 (escapable, merge→one High + positive); reframe verdict + methodology; record B blockers
```
