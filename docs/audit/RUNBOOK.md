...
| #5 timeline | Wednesday MVP submission due **Wednesday MIDNIGHT** (user corrected from "noon" 2026-05-20; working = end of Wed 23:59 CT); early Fri; final Sun | user | the two brief PDFs disagreed; user resolved | ✅ recorded. **Open:** MVP scope = audit-only (detailed brief) vs audit + first fixes (deck slide 9) — unresolved |
